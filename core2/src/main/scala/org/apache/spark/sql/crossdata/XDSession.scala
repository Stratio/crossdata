...
class XDSession private(
   ...
   * ----------------------- */
   ...
   /*
    ...
    /**
      ...
      */
    @Experimental
  override def listenerManager: ExecutionListenerManager = sessionState.listenerManager
  ...
  override def udf: UDFRegistration = sessionState.udf
    ...
    /**
      ...
      */
    @Experimental
  override def streams: StreamingQueryManager = sessionState.streamingQueryManager
  ...
  override def newSession(): SparkSession = {
    ...
    /**
      ...
      */
    @transient
  override lazy val emptyDataFrame: DataFrame = {
  ...
  override def createDataFrame[A <: Product : TypeTag](rdd: RDD[A]): DataFrame = {
    ...
    /**
      ...
      * SELECT * queries will return the columns in an unoverride defined order.
      *
      * @since 2.0.0
      */
    ...
    /**
      ...
      */
    @Experimental
    override def createDataset[T : Encoder](data: java.util.List[T]): Dataset[T] = {
    ...
    /**
      ...
      */
    @Experimental
    override def range(end: Long): Dataset[java.lang.Long] = range(0, end)
  ...
  override def readStream: DataStreamReader = new DataStreamReader(self)
   ...
   /* @Experimental
    object implicits extends SQLImplicits with Serializable {
      protected override def _sqlContext: SQLContext = sql.SparkSession.this.sqlContext
    }*/
    // scalastyle:on
    ...
    /**
      ...
      */
  override protected[sql] def parseDataType(dataTypeString: String): DataType = {
