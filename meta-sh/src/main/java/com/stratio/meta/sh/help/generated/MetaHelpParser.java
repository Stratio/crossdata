...
public class MetaHelpParser extends Parser {
	...
	public static final BitSet FOLLOW_T_DESCRIBE_in_describeHelpStatement1257 = new BitSet(new long[]{0x0180000000000002L,0x0000000000000300L});
	public static final BitSet FOLLOW_T_KEYSPACES_in_describeHelpStatement1266 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_KEYSPACE_in_describeHelpStatement1274 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_TABLES_in_describeHelpStatement1282 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_TABLE_in_describeHelpStatement1290 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_ALTER_in_alterHelpStatement1310 = new BitSet(new long[]{0x0080000000000002L,0x0000000000000100L});
	public static final BitSet FOLLOW_T_KEYSPACE_in_alterHelpStatement1319 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_TABLE_in_alterHelpStatement1327 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_LIST_in_listHelpStatement1347 = new BitSet(new long[]{0x0000000000000002L,0x0000000000002401L});
	public static final BitSet FOLLOW_T_PROCESS_in_listHelpStatement1356 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_UDF_in_listHelpStatement1364 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_TRIGGER_in_listHelpStatement1372 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_DROP_in_dropHelpStatement1392 = new BitSet(new long[]{0x0088000000000002L,0x0000000000000500L});
	public static final BitSet FOLLOW_T_KEYSPACE_in_dropHelpStatement1401 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_T_TRIGGER_in_dropHelpStatement1425 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_INSERT_in_insertHelpStatement1445 = new BitSet(new long[]{0x0020000000000002L});
	public static final BitSet FOLLOW_T_INTO_in_insertHelpStatement1454 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_CREATE_in_createHelpStatement1474 = new BitSet(new long[]{0x0888004000000002L,0x0000000000000100L});
	public static final BitSet FOLLOW_T_KEYSPACE_in_createHelpStatement1483 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_TABLE_in_createHelpStatement1491 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_INDEX_in_createHelpStatement1499 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_DEFAULT_in_createHelpStatement1508 = new BitSet(new long[]{0x0008000000000000L});
	public static final BitSet FOLLOW_T_INDEX_in_createHelpStatement1510 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_LUCENE_in_createHelpStatement1520 = new BitSet(new long[]{0x0008000000000000L});
	public static final BitSet FOLLOW_T_INDEX_in_createHelpStatement1522 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_createHelpStatement_in_helpStatement1573 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_UPDATE_in_helpStatement1582 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_insertHelpStatement_in_helpStatement1593 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_TRUNCATE_in_helpStatement1602 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_dropHelpStatement_in_helpStatement1613 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_listHelpStatement_in_helpStatement1642 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_REMOVE_in_helpStatement1651 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
	...
	public static final BitSet FOLLOW_alterHelpStatement_in_helpStatement1695 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_STOP_in_helpStatement1704 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_describeHelpStatement_in_helpStatement1718 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_T_HELP_in_query1747 = new BitSet(new long[]{0x041072B00C000000L,0x000000000000487EL});
	public static final BitSet FOLLOW_helpStatement_in_query1752 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000010L});
	public static final BitSet FOLLOW_T_SEMICOLON_in_query1759 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000010L});
