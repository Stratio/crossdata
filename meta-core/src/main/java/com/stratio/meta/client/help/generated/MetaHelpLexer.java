// $ANTLR 3.5.1 MetaHelp.g 2014-02-25 15:09:54

	package com.stratio.meta.client.help.generated;
...
public class MetaHelpLexer extends Lexer {
	...
	public final void mT_DROP() throws RecognitionException {
		try {
			int _type = T_DROP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:85:7: ( D R O P )
			// MetaHelp.g:85:9: D R O P
			{
			mD(); 
	...
	public final void mT_TABLE() throws RecognitionException {
		try {
			int _type = T_TABLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:86:8: ( T A B L E )
			// MetaHelp.g:86:10: T A B L E
			{
			mT(); 
	...
	public final void mT_USE() throws RecognitionException {
		try {
			int _type = T_USE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:87:6: ( U S E )
			// MetaHelp.g:87:8: U S E
			{
			mU(); 
	...
	public final void mT_SET() throws RecognitionException {
		try {
			int _type = T_SET;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:88:6: ( S E T )
			// MetaHelp.g:88:8: S E T
			{
			mS(); 
	...
	public final void mT_OPTIONS() throws RecognitionException {
		try {
			int _type = T_OPTIONS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:89:10: ( O P T I O N S )
			// MetaHelp.g:89:12: O P T I O N S
			{
			mO(); 
	...
	public final void mT_ANALYTICS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:90:12: ( A N A L Y T I C S )
			// MetaHelp.g:90:14: A N A L Y T I C S
			{
			mA(); 
	...
	public final void mT_CONSISTENCY() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:91:14: ( C O N S I S T E N C Y )
			// MetaHelp.g:91:16: C O N S I S T E N C Y
			{
			mC(); 
	...
	public final void mT_EXPLAIN() throws RecognitionException {
		try {
			int _type = T_EXPLAIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:92:10: ( E X P L A I N )
			// MetaHelp.g:92:12: E X P L A I N
			{
			mE(); 
	...
	public final void mT_PLAN() throws RecognitionException {
		try {
			int _type = T_PLAN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:93:7: ( P L A N )
			// MetaHelp.g:93:9: P L A N
			{
			mP(); 
	...
	public final void mT_FOR() throws RecognitionException {
		try {
			int _type = T_FOR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:94:6: ( F O R )
			// MetaHelp.g:94:8: F O R
			{
			mF(); 
	...
	public final void mT_INDEX() throws RecognitionException {
		try {
			int _type = T_INDEX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:95:8: ( I N D E X )
			// MetaHelp.g:95:10: I N D E X
			{
			mI(); 
	...
	public final void mT_HASH() throws RecognitionException {
		try {
			int _type = T_HASH;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:96:7: ( H A S H )
			// MetaHelp.g:96:9: H A S H
			{
			mH(); 
	...
	public final void mT_LIST() throws RecognitionException {
		try {
			int _type = T_LIST;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:97:7: ( L I S T )
			// MetaHelp.g:97:9: L I S T
			{
			mL(); 
	...
	public final void mT_REMOVE() throws RecognitionException {
		try {
			int _type = T_REMOVE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:98:9: ( R E M O V E )
			// MetaHelp.g:98:11: R E M O V E
			{
			mR(); 
	...
	public final void mT_UDF() throws RecognitionException {
		try {
			int _type = T_UDF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:99:6: ( U D F )
			// MetaHelp.g:99:8: U D F
			{
			mU(); 
	...
	public final void mT_PROCESS() throws RecognitionException {
		try {
			int _type = T_PROCESS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:100:10: ( P R O C E S S )
			// MetaHelp.g:100:12: P R O C E S S
			{
			mP(); 
	...
	public final void mT_TRIGGER() throws RecognitionException {
		try {
			int _type = T_TRIGGER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:101:10: ( T R I G G E R )
			// MetaHelp.g:101:12: T R I G G E R
			{
			mT(); 
	...
	public final void mT_STOP() throws RecognitionException {
		try {
			int _type = T_STOP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:102:7: ( S T O P )
			// MetaHelp.g:102:9: S T O P
			{
			mS(); 
	...
	public final void mT_USING() throws RecognitionException {
		try {
			int _type = T_USING;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:103:8: ( U S I N G )
			// MetaHelp.g:103:10: U S I N G
			{
			mU(); 
	...
	public final void mT_TYPE() throws RecognitionException {
		try {
			int _type = T_TYPE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:104:7: ( T Y P E )
			// MetaHelp.g:104:9: T Y P E
			{
			mT(); 
	...
	public final void mT_ADD() throws RecognitionException {
		try {
			int _type = T_ADD;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:105:6: ( A D D )
			// MetaHelp.g:105:8: A D D
			{
			mA(); 
	...
	public final void mT_PRIMARY() throws RecognitionException {
		try {
			int _type = T_PRIMARY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:106:10: ( P R I M A R Y )
			// MetaHelp.g:106:12: P R I M A R Y
			{
			mP(); 
	...
	public final void mT_KEY() throws RecognitionException {
		try {
			int _type = T_KEY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:107:6: ( K E Y )
			// MetaHelp.g:107:8: K E Y
			{
			mK(); 
	...
	public final void mT_INSERT() throws RecognitionException {
		try {
			int _type = T_INSERT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:108:9: ( I N S E R T )
			// MetaHelp.g:108:11: I N S E R T
			{
			mI(); 
	...
	public final void mT_INTO() throws RecognitionException {
		try {
			int _type = T_INTO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:109:7: ( I N T O )
			// MetaHelp.g:109:9: I N T O
			{
			mI(); 
	...
	public final void mT_COMPACT() throws RecognitionException {
		try {
			int _type = T_COMPACT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:110:10: ( C O M P A C T )
			// MetaHelp.g:110:12: C O M P A C T
			{
			mC(); 
	...
	public final void mT_STORAGE() throws RecognitionException {
		try {
			int _type = T_STORAGE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:111:10: ( S T O R A G E )
			// MetaHelp.g:111:12: S T O R A G E
			{
			mS(); 
	...
	public final void mT_CLUSTERING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:112:13: ( C L U S T E R I N G )
			// MetaHelp.g:112:15: C L U S T E R I N G
			{
			mC(); 
	...
	public final void mT_ORDER() throws RecognitionException {
		try {
			int _type = T_ORDER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:113:8: ( O R D E R )
			// MetaHelp.g:113:10: O R D E R
			{
			mO(); 
	...
	public final void mT_SELECT() throws RecognitionException {
		try {
			int _type = T_SELECT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:114:9: ( S E L E C T )
			// MetaHelp.g:114:11: S E L E C T
			{
			mS(); 
	...
	public final void mT_VALUES() throws RecognitionException {
		try {
			int _type = T_VALUES;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:115:9: ( V A L U E S )
			// MetaHelp.g:115:11: V A L U E S
			{
			mV(); 
	...
	public final void mT_UPDATE() throws RecognitionException {
		try {
			int _type = T_UPDATE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:116:9: ( U P D A T E )
			// MetaHelp.g:116:11: U P D A T E
			{
			mU(); 
	...
	public final void mT_FROM() throws RecognitionException {
		try {
			int _type = T_FROM;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:117:7: ( F R O M )
			// MetaHelp.g:117:9: F R O M
			{
			mF(); 
	...
	public final void mT_DELETE() throws RecognitionException {
		try {
			int _type = T_DELETE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:118:9: ( D E L E T E )
			// MetaHelp.g:118:11: D E L E T E
			{
			mD(); 
	...
	public final void mT_DISABLE() throws RecognitionException {
		try {
			int _type = T_DISABLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:119:10: ( D I S A B L E )
			// MetaHelp.g:119:12: D I S A B L E
			{
			mD(); 
	...
	public final void mT_DISTINCT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:120:11: ( D I S T I N C T )
			// MetaHelp.g:120:13: D I S T I N C T
			{
			mD(); 
	...
	public final void mT_COUNT() throws RecognitionException {
		try {
			int _type = T_COUNT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:121:8: ( C O U N T )
			// MetaHelp.g:121:10: C O U N T
			{
			mC(); 
	...
	public final void mT_AS() throws RecognitionException {
		try {
			int _type = T_AS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:122:5: ( A S )
			// MetaHelp.g:122:7: A S
			{
			mA(); 
	...
	public final void mT_BETWEEN() throws RecognitionException {
		try {
			int _type = T_BETWEEN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:123:10: ( B E T W E E N )
			// MetaHelp.g:123:12: B E T W E E N
			{
			mB(); 
	...
	public final void mT_ASC() throws RecognitionException {
		try {
			int _type = T_ASC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:124:6: ( A S C )
			// MetaHelp.g:124:8: A S C
			{
			mA(); 
	...
	public final void mT_DESC() throws RecognitionException {
		try {
			int _type = T_DESC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:125:7: ( D E S C )
			// MetaHelp.g:125:9: D E S C
			{
			mD(); 
	...
	public final void mT_LIKE() throws RecognitionException {
		try {
			int _type = T_LIKE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:126:7: ( L I K E )
			// MetaHelp.g:126:9: L I K E
			{
			mL(); 
	...
	public final void mT_HELP() throws RecognitionException {
		try {
			int _type = T_HELP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:127:7: ( H E L P )
			// MetaHelp.g:127:9: H E L P
			{
			mH(); 
	...
	public final void mT_EXIT() throws RecognitionException {
		try {
			int _type = T_EXIT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:128:7: ( E X I T )
			// MetaHelp.g:128:9: E X I T
			{
			mE(); 
	...
	public final void mT_QUIT() throws RecognitionException {
		try {
			int _type = T_QUIT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:129:7: ( Q U I T )
			// MetaHelp.g:129:9: Q U I T
			{
			mQ(); 
	...
	public final void mT_DATATYPES() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:130:12: ( D A T A T Y P E S )
			// MetaHelp.g:130:14: D A T A T Y P E S
			{
			mD(); 
	...
	public final void mT_LUCENE() throws RecognitionException {
		try {
			int _type = T_LUCENE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:131:9: ( L U C E N E )
			// MetaHelp.g:131:11: L U C E N E
			{
			mL(); 
	...
	public final void mT_DEFAULT() throws RecognitionException {
		try {
			int _type = T_DEFAULT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MetaHelp.g:132:10: ( D E F A U L T )
			// MetaHelp.g:132:12: D E F A U L T
			{
			mD(); 
	...
	static final String[] DFA4_transitionS = {
			...
			"",
			"",
			"\1\70\1\67\6\uffff\1\71\27\uffff\1\70\1\67\6\uffff\1\71",
			"",
			"",
			"",
			"",
			...
			"\1\74\37\uffff\1\74",
			"",
			"\1\77\5\uffff\1\75\6\uffff\1\76\22\uffff\1\77\5\uffff\1\75\6\uffff\1"+
			"\76",
			"\1\100\37\uffff\1\100",
			"",
			...
			"",
			"",
			"\1\107\6\uffff\1\106\30\uffff\1\107\6\uffff\1\106",
			"",
			"\1\111\5\uffff\1\110\31\uffff\1\111\5\uffff\1\110",
			"",
			"",
			"\1\112\16\uffff\1\113\1\114\17\uffff\1\112\16\uffff\1\113\1\114",
			"",
			"",
