...
public class AlterKeyspaceStatementTest extends BasicValidatorTest {
    ...
    public void testValidateAlterKeyspace(){
        String inputText = "ALTER KEYSPACE demo WITH replication = {'class': 'org.apache.cassandra.locator.SimpleStrategy', 'replication_factor': '2'};";

        Map<String, ValueProperty> properties = new HashMap<>();
        properties.put("replication", new IdentifierProperty("{'class': 'org.apache.cassandra.locator.SimpleStrategy', 'replication_factor': '2'}"));
    ...
    public void testValidateAlterKeyspaceWithWrongKeyspace(){
        String inputText = "ALTER KEYSPACE unknown WITH replication = {'class': 'org.apache.cassandra.locator.NetworkTopologyStrategy'};";
