...
1. Running the connector tests ::
    ...
    -inmemory-0.3.3.jar" -DconnectorDefinition="[CrossdataPath]/crossdata-connector-inmemory/target/crossdata
    -connector-inmemory-0.3.3/conf/InMemoryConnector.xml" -DclusterOptions="[TableRowLimit-100]"
