...
public class DataProviderSparkSQLConnector {

    @DataProvider(parallel = false)
    public static Iterator<String[]> dataProvider(ITestContext context, Constructor<?> testConstructor)
            throws Exception {
    	  URL url = DataProviderInMemoryConnector.class.getResource("/manifest/SparkSQLConnector.xml");
          ...
          URL url_fun = DataProviderInMemoryConnector.class.getResource("/manifest/HDFSDataStore.xml");
