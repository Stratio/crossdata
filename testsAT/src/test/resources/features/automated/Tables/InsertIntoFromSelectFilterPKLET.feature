Feature: Insert Into from select with filter_pk_lt tests
  ...
  Scenario: INSERT INTO catalogTest.testTable(id, name, age, phone, salary, reten, new) SELECT * FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert(id, name, age, phone, salary, reten, new) SELECT * FROM catalogTest.tableTest WHERE id <=4 ;'
    Then the result has not errors: 'false'
  ...
  Scenario: INSERT INTO catalogTest.testTableInsert1(id, name) SELECT id, name FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert1(id, name) SELECT id, name FROM catalogTest.tableTest WHERE id <=4 ;'
    Then the result has not errors: 'false'
  ...
  Scenario: INSERT INTO catalogTest.testTableInsert11(name, id) SELECT name, id FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert11(name, id) SELECT name, id FROM catalogTest.tableTest WHERE id <=4 ;'
    Then the result has not errors: 'false'
  ...
  Scenario: INSERT INTO catalogTest.testTableInsert2(id, name, age) SELECT id, name FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert2(id, name, age) SELECT id, name FROM catalogTest.tableTest WHERE id <=4 ;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert3(id, name) SELECT id, name, age FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert3(id, name) SELECT id, name, age FROM catalogTest.tableTest WHERE id <=4 ;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert4(id, name) SELECT id, age FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert4(id, name) SELECT id, age FROM catalogTest.tableTest WHERE id <=4 ;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert5(name) SELECT name FROM catalogTest.tableTest WHERE id <=4 ;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert5(name) SELECT name FROM catalogTest.tableTest WHERE id <=4 ;'
    Then an exception 'IS' thrown
