Feature: Insert Into from select with filter_pk_eq tests

  Scenario: INSERT INTO catalogTest.testTable(id, name, age, phone, salary, reten, new) SELECT * FROM catalogTest.tableTest WHERE id = 1;;
    ...
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert(id, name, age, phone, salary, reten, new) SELECT * FROM catalogTest.tableTest WHERE id = 1;'
    Then the result has not errors: 'false'
  ...
  Scenario: INSERT INTO catalogTest.testTableInsert1(id, name) SELECT id, name FROM catalogTest.tableTest WHERE id = 1;;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert1(id, name) SELECT id, name FROM catalogTest.tableTest WHERE id = 1;;'
    Then the result has not errors: 'false'
  ...
  Scenario: INSERT INTO catalogTest.testTableInsert11(name, id) SELECT name, id FROM catalogTest.tableTest WHERE id = 1;;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert11(name, id) SELECT name, id FROM catalogTest.tableTest WHERE id = 1;;'
    Then the result has not errors: 'false'
  ...
  Scenario: INSERT INTO catalogTest.testTableInsert2(id, name, age) SELECT id, name FROM catalogTest.tableTest WHERE id = 1;;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert2(id, name, age) SELECT id, name FROM catalogTest.tableTest WHERE id = 1;;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert3(id, name) SELECT id, name, age FROM catalogTest.tableTest WHERE id = 1;;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert3(id, name) SELECT id, name, age FROM catalogTest.tableTest WHERE id = 1;;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert4(id, name) SELECT id, age FROM catalogTest.tableTest WHERE id = 1;;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert4(id, name) SELECT id, age FROM catalogTest.tableTest WHERE id = 1;;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert5(name) SELECT name FROM catalogTest.tableTest WHERE id = 1;;
    ...
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert5(name) SELECT name FROM catalogTest.tableTest WHERE id = 1;;'
    Then an exception 'IS' thrown

  Scenario: INSERT INTO catalogTest.testTableInsert6(id, name, age, phone, salary, reten, new) SELECT * FROM catalogTest.tableTest WHERE id = 100;
    When I execute a query: 'CREATE TABLE catalogTest.testTableInsert6 ON CLUSTER ClusterTest(id int, name text, age int, phone BIGINT, salary DOUBLE, reten FLOAT, new BOOLEAN, PRIMARY KEY(id));'
    Then the table 'catalogtest.testTableInsert6' has to exists: 'true'
    Then the result has not errors: 'false'
    When I execute a query: 'INSERT INTO catalogTest.testTableInsert6(id, name, age, phone, salary, reten, new) SELECT * FROM catalogTest.tableTest WHERE id = 100;'
    Then the result has not errors: 'false'
    When I execute a query: 'SELECT id, name FROM catalogTest.testTableInsert6;'
    Then the result has to be:
      | catalogTest.testTableInsert6.id-id-Integer | catalogTest.testTableInsert6.name-name-String |
