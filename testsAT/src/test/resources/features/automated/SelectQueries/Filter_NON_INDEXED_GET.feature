Feature: Basic Select queries with FILTER_NON_INDEXED_GET

  Scenario: SELECT * FROM catalogTest.tableTest WHERE age >= 60;
    When I execute a query: 'SELECT * FROM catalogTest.tableTest WHERE age >= 60;'
  ...
  Scenario: SELECT id FROM catalogTest.tableTest WHERE age >= 60;
    When I execute a query: 'SELECT id FROM catalogTest.tableTest WHERE age >= 60;'
    Then the result has to be:
  ...
  Scenario: SELECT * FROM catalogTest.tab3 WHERE age >= 31;
    When I execute a query: 'SELECT * FROM catalogTest.tab3 WHERE age >= 31;'
    Then the result has to be:
      | catalogTest.tab3.id-id-BigInteger | catalogTest.tab3.age-age-BigInteger |
