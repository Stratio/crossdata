Feature: Basic Select queries with FILTER_PK_LT

  Scenario: SELECT * FROM catalogTest.tableTest WHERE id < 5;
    When I execute a query: 'SELECT * FROM catalogTest.tableTest WHERE id < 5;'
  ...
  Scenario: SELECT id AS identificador FROM catalogTest.tableTest WHERE identificador < 5;
    When I execute a query: 'SELECT id AS identificador FROM catalogTest.tableTest WHERE identificador < 5;'
    Then the result has to be:
  ...
  Scenario: SELECT * FROM catalogTest.tab4 WHERE money < 0.0;
    When I execute a query: 'SELECT * FROM catalogTest.tab4 WHERE money < 0.0;'
    Then the result has to be:
      | catalogTest.tab4.money-money-Double | catalogTest.tab4.reten-reten-Double |
      | -4.4                                | -40.40                              |

  Scenario: SELECT * FROM catalogTest.tab4 WHERE money < 4;
    When I execute a query: 'SELECT * FROM catalogTest.tab4 WHERE money < 4;'
    Then the result has to be:
      | catalogTest.tab4.money-money-Double | catalogTest.tab4.reten-reten-Double |
      | -4.4                                | -40.40                              |
      | 1.1                                 | 10.10                               |
  ...
  Scenario: SELECT * FROM catalogTest.tab5 WHERE money < 4;
    When I execute a query: 'SELECT * FROM catalogTest.tab5 WHERE money < 4;'
    Then the result has to be:
      | catalogTest.tab5.money-money-Double | catalogTest.tab5.reten-reten-Double |
      | -4.4                                | -40.40                              |
      | 1.1                                 | 10.10                               |
