Feature: Basic Select queries with FILTER_NON_INDEXED_LT
  ...
  Scenario: SELECT * FROM catalogTest.tableTest WHERE age <= 40;
    When I execute a query: 'SELECT * FROM catalogTest.tableTest WHERE age <= 40;'
  ...
  Scenario: SELECT id FROM catalogTest.tableTest WHERE age <= 40;
    When I execute a query: 'SELECT id FROM catalogTest.tableTest WHERE age <= 40;'
    Then the result has to be:
  ...
  Scenario: SELECT * FROM catalogTest.tab3 WHERE age < 30;
    When I execute a query: 'SELECT * FROM catalogTest.tab3 WHERE age <= 20;'
    Then the result has to be:
      | catalogTest.tab3.id-id-BigInteger | catalogTest.tab3.age-age-BigInteger |
      | -4                                | -40                                 |
      | 1                                 | 10                                  |
  ...
  Scenario: SELECT * FROM catalogTest.tab4 WHERE reten <= 30.30;
    When I execute a query: 'SELECT * FROM catalogTest.tab4 WHERE reten <= 30.30;'
    Then the result has to be:
      | catalogTest.tab4.money-money-Double | catalogTest.tab4.reten-reten-Double |
      | -4.4                                | -40.40                              |
      | 1.1                                 | 10.10                               |
