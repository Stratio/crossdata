...
CREATE TABLE IF NOT EXISTS catalogTest.tableTest ON CLUSTER ClusterTest(id int, name text, age int, phone BIGINT, salary DOUBLE, reten FLOAT, new BOOLEAN, PRIMARY KEY(id, name));
