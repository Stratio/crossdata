...
trait CatalogConstants {
  ...
  val arrayField =
    StructField(SubField2Name, ArrayType(StringType), nullable = true)
  val arrayFieldIntegers =
    StructField(SubField2Name, ArrayType(IntegerType), nullable = true)
  val arrayFieldWithSubDocs = StructField(
      FieldWitStrangeChars,
      ArrayType(StructType(Seq(Field1, Field2))))
  ...
  val ColumnsWithSubColumns = StructType(
      Seq(StructField(Field1Name, StringType, nullable = true),
          StructField(FieldWithSubcolumnsName,
                      StructType(SubFields),
                      nullable = true)))
  val ColumnsWithArrayString = StructType(
      Seq(StructField(Field1Name, StringType, nullable = true),
          StructField(FieldWithSubcolumnsName,
                      StructType(SubFields),
                      nullable = true),
          arrayField))
  val ColumnsWithArrayInteger = StructType(
      Seq(StructField(Field1Name, StringType, nullable = true),
          StructField(FieldWithSubcolumnsName,
                      StructType(SubFields),
                      nullable = true),
          arrayFieldIntegers))
  val ColumnsWithArrayWithSubdocuments = StructType(
      Seq(StructField(Field1Name, StringType, nullable = true),
          StructField(FieldWithSubcolumnsName,
                      StructType(SubFields),
                      nullable = true),
          arrayFieldWithSubDocs))
  val ColumnsWithMapWithArrayWithSubdocuments = StructType(
      Seq(
          StructField(Field1Name,
                      MapType(ColumnsWithSubColumns,
