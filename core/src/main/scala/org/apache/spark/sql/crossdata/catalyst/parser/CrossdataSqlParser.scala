...
private[spark] class CrossdataParserDialect extends ParserDialect {
  @transient
  protected val sqlParser = CrossdataSqlParser
...
/**
  ...
  */
object CrossdataSqlParser extends AbstractSparkSQLParser with DataTypeParser {
