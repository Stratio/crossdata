...
public class ParsingTest {
	...
	public void createIndex_default_basic() {
		...
		assertEquals("Cannot parse basic default index", inputText, st.toString()+";");
	}
	...
	public void createIndex_default_ifNotExist() {
		...
		assertEquals("Cannot parse default index with if not exists", inputText, st.toString()+";");
	}
	...
	public void createIndex_default_using() {
		...
		assertEquals("Cannot parse default index with using clause", inputText, st.toString()+";");
	}
