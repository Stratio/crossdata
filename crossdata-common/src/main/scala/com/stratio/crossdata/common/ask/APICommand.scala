...
object APICommand extends Enumeration {
  ...
  val DISCOVER_METADATA = Value("DISCOVER_METADATA")
  val IMPORT_CATALOGS = Value("IMPORT_CATALOGS")
  val IMPORT_CATALOG = Value("IMPORT_CATALOG")
  val IMPORT_TABLE = Value("IMPORT_TABLE")
}
