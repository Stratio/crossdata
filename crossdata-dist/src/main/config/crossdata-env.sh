...
# CROSSDATA_LOG_OUT
CROSSDATA_LOG_OUT=/var/log/sds/crossdata/crossdata-server.out
# CROSSDATA_LOG_ERROR
CROSSDATA_LOG_ERR=/var/log/sds/crossdata/crossdata-server.err
# CROSSDATA_SERVER_USER
CROSSDATA_SERVER_USER="root"
# CROSSDATA_SERVER_PID
CROSSDATA_SERVER_PID=/var/run/sds/crossdata-server.pid
