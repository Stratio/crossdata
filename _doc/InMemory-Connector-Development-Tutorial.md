...
1. Running the connector tests:
    ...
    -inmemory-0.1.1-RC2.jar" -DconnectorDefinition="[CrossdataPath]/crossdata-connector-inmemory/target/crossdata
    -connector-inmemory-0.1.1-RC2/conf/InMemoryConnector.xml" -DclusterOptions="[TableRowLimit-100]"
