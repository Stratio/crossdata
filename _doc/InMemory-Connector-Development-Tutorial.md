...
1. Running the connector tests:
    ...
    -inmemory-0.1.2-SNAPSHOT.jar" -DconnectorDefinition="[CrossdataPath]/crossdata-connector-inmemory/target/crossdata
    -connector-inmemory-0.1.2-SNAPSHOT/conf/InMemoryConnector.xml" -DclusterOptions="[TableRowLimit-100]"
