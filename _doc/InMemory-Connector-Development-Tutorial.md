...
1. Running the connector tests:
    ...
    -inmemory-0.2.1.jar" -DconnectorDefinition="[CrossdataPath]/crossdata-connector-inmemory/target/crossdata
    -connector-inmemory-0.2.1/conf/InMemoryConnector.xml" -DclusterOptions="[TableRowLimit-100]"
