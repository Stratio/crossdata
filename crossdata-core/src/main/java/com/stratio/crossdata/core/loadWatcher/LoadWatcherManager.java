...
import com.stratio.crossdata.core.execution.ExecutionManagerException;

/**
 * Singleton to manage the metadata store.
 */
public enum LoadWatcherManager {
     ...
     *
     * @param data The map used to persist the elements.
     * @param writeLock     The write lock.
     * @param tm            The transaction manager.
     */
    public synchronized void init(Map<String, Serializable> data, Lock writeLock, TransactionManager tm) {
        if (data != null && writeLock != null) {
            this.data = data;
